...
app.get("/filter", (req, res) => {
  ...
  const foundJokes = jokes.filter((joke) => joke.jokeType.toLowerCase() === req.query.type.toLowerCase());
  res.json(foundJokes);
});
//4. POST a new joke
...
app.patch("/jokes/:id", (req, res) => {
  ...
  jokes[idx] = {
    id: id,
    jokeText: req.body.text || jokes[idx].jokeText,
    jokeType: req.body.type || jokes[idx].jokeType,
  }
  res.json(jokes[idx]);
})
